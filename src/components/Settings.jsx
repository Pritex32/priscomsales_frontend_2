  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!requisition && response.data) {
        ...
        if (emailSent) {
          const fullMsg = `${successMsg}. Email notification sent to inventory officer.`;
          setSuccess(fullMsg);
          toast.success(successMsg);
          toast.info('Email notification sent to inventory officer');
        } else if (!emailConfigured) {
          const fullMsg = `${successMsg}. Warning: No inventory officer email configured. Please set it up in Settings.`;
          setSuccess(fullMsg);
          toast.success(successMsg);
